...
- Signature: Sand Castle Therapy (nature-based play therapy for children on the Laguna sand). Tagline: "Building resilience, one sand castle at a time." Developed by Kathleen "Kay" Wenger, LMFT, LPCC, and Laguna Beach Counseling. Children use sand, imagination, storytelling, and therapeutic play at the beach to build emotional resilience, coping skills, confidence, communication, and stronger family relationships. The Six Pillars: Build (a castle, and trust with the therapist), Create (expressing thoughts and feelings through imagination), Explore (the therapist gently explores emotions, relationships, fears, strengths, hopes), Repair (waves and accidents become practice in coping, flexibility, resilience), Grow (skills practiced naturally through play, problem-solving, emotional coaching), Take Home (parents get simple strategies to keep building resilience at home). Delivered by Rozy Pishvaiy, AMFT, the practice's children specialist. Offered after school and on weekends. TRADEMARK STATUS: unregistered, and NO SYMBOL IS USED ANYWHERE. The trademark symbol was REMOVED BY CLIENT DECISION, September 2026, reversing the earlier rule that carried the unregistered mark on first prominent use per section. The service name is now plain on every surface: site pages, nav, meta descriptions, FAQ answers, schema and docs. The name itself is unchanged, still "Sand Castle Therapy", two words, capitalised. If a symbol is ever reinstated it is the unregistered one (™) and never the registered one (®), and only once registration is confirmed and recorded here first. Presenting concerns confirmed for this model: anxiety, school avoidance, divorce, ADHD, grief, social anxiety, depression, self-esteem, emotional regulation. Trauma is NOT on that list on purpose; trauma-focused child work implies modality training (EMDR, TF-CBT) that is not confirmed for this team (see Modalities). Add it only if Kay confirms the credential. Source: client-supplied Sand Castle Therapy materials via Kay, August 2026. NOT FOR PUBLICATION (internal roadmap, do not put on any client-facing surface): the book, workbook, therapist manual, certification program, CE course, research study, and TEDx plans.
