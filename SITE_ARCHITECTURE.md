...
- **Tier:** [Micro / Standard - to be confirmed]
- **Bilingual:** [Yes / No - to be confirmed]
- **Blog:** [Yes / No - to be confirmed]
- **Booking:** [Yes / No - to be confirmed]
- **Answer Engine (AEO):** [Yes / No - to be confirmed]
- **PWA:** [Yes / No - to be confirmed]
...
- **Business name:** Laguna Beach Counseling
...
## Bilingual Configuration (if applicable)

[Map hreflang and twin-URL structure if bilingual]
...
- **Copy source:** [Client-supplied / Agency-human / Agency-AI - to be confirmed]
- **Image source:** [Client photos / Licensed stock / Professional shoot - to be confirmed]
- **Content deadline:** [Date if client-supplied]
